...
class Tabs extends React.PureComponent {
    constructor() {
        ...
        this.handleFocus = (event) => {
            ...
            if (!relatedTarget.classList.contains(styles.Tab) &&
    ...
    render() {
        ...
        const activator = (<button tabIndex={-1} className={styles.DisclosureActivator} onClick={this.handleDisclosureActivatorClick} aria-label={intl.translate('Polaris.Tabs.toggleTabsLabel')}>
