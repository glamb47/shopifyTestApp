...
export default function Sheet({ children, open, onClose, onEntered, onExit, }) {
    ...
    }, 40, { leading: true, trailing: true, maxWait: 40 }), [mobile]);
    useEffect(() => {
        handleResize();
    }, 
    ...
    return (<Portal idPrefix="sheet">
      <CSSTransition findDOMNode={findDOMNode} classNames={mobile ? BOTTOM_CLASS_NAMES : RIGHT_CLASS_NAMES} timeout={Duration.Slow} in={open} mountOnEnter unmountOnExit onEntered={onEntered} onExit={onExit}>
        <div className={styles.Container} {...layer.props} {...overlay.props} ref={container}>
