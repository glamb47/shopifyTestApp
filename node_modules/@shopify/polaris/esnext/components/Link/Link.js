...
export default function Link({ url, children, onClick, external, id, monochrome, }) {
    const intl = useI18n();
    let childrenMarkup = children;
    if (external && typeof children === 'string') {
        const iconLabel = intl.translate('Polaris.Common.newWindowAccessibilityHint');
    ...
    return (<BannerContext.Consumer>
      {(BannerContext) => {
        ...
        const className = classNames(styles.Link, shouldBeMonochrome && styles.monochrome);
