...
class Filters extends React.Component {
    ...
    render() {
        const { filters, queryValue, onQueryBlur, onQueryChange, onQueryFocus, focused, onClearAll, appliedFilters, polaris: { intl }, onQueryClear, queryPlaceholder, children, } = this.props;
        ...
        const filtersContentMarkup = filters.map((filter, index) => {
            ...
            const className = classNames(styles.FilterTriggerContainer, filterIsOpen && styles.open, index === 0 && styles.first, index === filters.length - 1 && styles.last);
        ...
        const filtersControlMarkup = (<ConnectedFilterControl rightPopoverableActions={this.transformFilters(filters)} rightAction={rightActionMarkup} auxiliary={children}>
        <TextField placeholder={queryPlaceholder ||
            ...
            </span>} clearButton onClearButtonClick={onQueryClear}/>
        ...
        const filtersContainerMarkup = mobile ? (<Sheet open={open} onClose={this.closeFilters} onEntered={this.setReadyForFocus(true)} onExit={this.setReadyForFocus(false)}>
