...
export default function Select({ options: optionsProp, label, labelAction, labelHidden: labelHiddenProp, labelInline, disabled, helpText, placeholder, id = getUniqueID(), name, value = PLACEHOLDER_VALUE, error, onChange, onFocus, onBlur, }) {
