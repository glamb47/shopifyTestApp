...
class BulkActions extends React.PureComponent {
    ...
    render() {
        ...
        const smallScreenGroup = (<Transition timeout={0} in={selectMode} key="smallGroup" findDOMNode={this.findSmallScreenGroupNode}>
        {(status) => {
        ...
        const largeScreenGroup = (<Transition timeout={0} in={selectMode} key="largeGroup" findDOMNode={this.findLargeScreenGroupNode}>
        {(status) => {
