...
export default class BulkActionButton extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.bulkActionButton = createRef();
    }
    componentDidMount() {
    ...
    render() {
        ...
        return (<button className={className} onClick={onAction} onMouseUp={handleMouseUpByBlurring} aria-label={accessibilityLabel} type="button" disabled={disabled} ref={this.bulkActionButton}>
        {contentMarkup}
      </button>);
    }
}
