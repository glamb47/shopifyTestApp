import React__default, { useContext, useRef, useEffect, createRef, useState, useCallback, createContext, memo, Fragment, createElement } from 'react';
...
import { CaretDownMinor, HorizontalDotsMinor, TickSmallMinor, AlertMinor, CaretUpMinor, CircleCancelMinor, CancelSmallMinor, CircleTickMajorTwotone, CircleInformationMajorTwotone, CircleAlertMajorTwotone, CircleDisabledMajorTwotone, FlagMajorTwotone, ChevronLeftMinor, MinusMinor, ChevronRightMinor, ArrowLeftMinor, ArrowRightMinor, ExternalSmallMinor, DragDropMajorMonotone, CircleAlertMajorMonotone, QuestionMarkMajorTwotone, MobileCancelMajorMonotone, ArrowUpDownMinor, CalendarMinor, SearchMinor, EnableSelectionMinor, ChevronUpMinor, ChevronDownMinor, MobileHamburgerMajorMonotone } from '@shopify/polaris-icons';
...
import { Redirect, ButtonGroup as ButtonGroup$1, Button as Button$1, Modal as Modal$2, Loading as Loading$3, TitleBar, ResourcePicker as ResourcePicker$2, Toast as Toast$3 } from '@shopify/app-bridge/actions';

if (typeof window !== 'undefined') {
  window.Polaris = window.Polaris || {};
  window.Polaris.VERSION = '4.0.0';
}

var polarisVersion = '4.0.0';
...
function Button(_ref) {
  ...
  if (url) {
    ...
    React__default.createElement("a", {
      ...
      className: className,
      "aria-label": accessibilityLabel
    }, content) : React__default.createElement(UnstyledLink$1, {
      id: id,
      url: url,
      external: external,
      download: download,
...
function ScrollTo() {
  ...
  var getUniqueId = createUniqueIDFactory("ScrollTo"); // eslint-disable-next-line jsx-a11y/anchor-is-valid
...
function Item$1(_ref) {
  ...
  var control = url ? React__default.createElement(UnstyledLink$1, {
    id: id,
    url: url,
    className: className,
    external: external,
...
function (_React$PureComponent) {
  ...
  function Card() {
    ...
    _this.toggleSecondaryActionsPopover = function () {
      _this.setState(function (_ref) {
        var secondaryFooterActionsPopoverOpen = _ref.secondaryFooterActionsPopoverOpen;
        return {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          secondaryFooterActions = _this$props.secondaryFooterActions,
          secondaryFooterActionsDisclosureText = _this$props.secondaryFooterActionsDisclosureText,
          intl = _this$props.polaris.intl;
        ...
        if (secondaryFooterActions.length === 1) {
          ...
          secondaryFooterActionsMarkup = React__default.createElement(React__default.Fragment, null, React__default.createElement(Popover, {
            ...
            activator: React__default.createElement(Button, {
              disclosure: true,
              onClick: this.toggleSecondaryActionsPopover
            }, secondaryFooterActionsDisclosureText || intl.translate('Polaris.Common.more')),
...
var Card$1 = withAppProvider()(Card);
...
function MenuAction(_ref) {
  ...
  if (url) {
    return React__default.createElement(UnstyledLink$1, {
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(RollupActions, _React$PureComponent);

  function RollupActions() {
    var _this;

    _classCallCheck(this, RollupActions);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(RollupActions).apply(this, arguments));
    _this.state = {
      rollupOpen: false
    };
    ...
    _this.handleRollupToggle = function () {
      _this.setState(function (_ref) {
        var rollupOpen = _ref.rollupOpen;
        return {
  ...
  _createClass(RollupActions, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          _this$props$items = _this$props.items,
          items = _this$props$items === void 0 ? [] : _this$props$items,
          _this$props$sections = _this$props.sections,
          sections = _this$props$sections === void 0 ? [] : _this$props$sections,
          intl = _this$props.polaris.intl;
      var rollupOpen = this.state.rollupOpen;
      ...
      var activatorMarkup = React__default.createElement("div", {
        ...
        accessibilityLabel: intl.translate('Polaris.ActionMenu.RollupActions.rollupButton'),
  ...
  return RollupActions;
}(React__default.PureComponent);

var RollupActions$1 = withAppProvider()(RollupActions);
...
function (_React$PureComponent) {
  ...
  _createClass(ActionMenu, [{
    ...
    value: function render() {
      ...
      }, rollup ? React__default.createElement(RollupActions$1, {
        items: actions,
...
var getUniqueID$2 = createUniqueIDFactory('Checkbox');
function Checkbox(_ref) {
  var _ref$id = _ref.id,
      id = _ref$id === void 0 ? getUniqueID$2() : _ref$id,
...
var getUniqueId = createUniqueIDFactory('OptionList');
function OptionList(_ref) {
  ...
  var id = useRef(propId || getUniqueId());
  ...
  var optionsMarkup = optionsExist ? normalizedOptions.map(function (_ref2, sectionIndex) {
    ...
    var optionsMarkup = options && options.map(function (option, optionIndex) {
      ...
      var optionId = option.id || "".concat(id.current, "-").concat(sectionIndex, "-").concat(optionIndex);
    ...
    return React__default.createElement("li", {
      ...
      id: "".concat(id.current, "-").concat(sectionIndex),
      role: role,
...
var getUniqueId$1 = createUniqueIDFactory('ComboBox');
  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      var _this$state7 = this.state,
          ...
          navigableOptions = _this$state7.navigableOptions,
          selectedOptions = _this$state7.selectedOptions;
    ...
    get: function get() {
      var _this$state8 = this.state,
          selectedOption = _this$state8.selectedOption,
          selectedIndex = _this$state8.selectedIndex,
          comboBoxId = _this$state8.comboBoxId;
...
var getUniqueID$3 = createUniqueIDFactory('TextField');
...
function (_React$PureComponent) {
  ...
  _createClass(Breadcrumbs, [{
    ...
    value: function render() {
      ...
      var breadcrumbMarkup = 'url' in breadcrumb ? React__default.createElement(UnstyledLink$1, {
        key: content,
        url: breadcrumb.url,
...
function CalloutCard(_ref) {
  ...
  return React__default.createElement(Card$1, null, React__default.createElement("div", {
    className: styles$A.Container
  }, dismissButton, React__default.createElement(Card$1.Section, null, React__default.createElement("div", {
...
var getUniqueID$4 = createUniqueIDFactory('Checkbox');
...
var getUniqueID$5 = createUniqueIDFactory('RadioButton');
...
var getUniqueID$6 = createUniqueIDFactory('ChoiceList');
...
var ContextualSaveBar$1 = React__default.memo(ContextualSaveBar);
...
function Link(_ref) {
  ...
  if (external && typeof children === 'string') {
    ...
    childrenMarkup = React__default.createElement(React__default.Fragment, null, children, React__default.createElement("span", {
      className: styles$M.IconLockup
    }, React__default.createElement("span", {
      className: styles$M.IconLayout
    }, React__default.createElement(Icon, {
  ...
  return React__default.createElement(BannerContext.Consumer, null, function (BannerContext) {
    ...
    var className = classNames(styles$M.Link, shouldBeMonochrome && styles$M.monochrome);
    return url ? React__default.createElement(UnstyledLink$1, {
      onClick: onClick,
      className: className,
      url: url,
      external: external,
...
function FileUpload(props) {
  ...
  var imageClasses = classNames(styles$N.Image, size && size === 'extraLarge' && styles$N.sizeExtraLarge, size && size === 'large' && styles$N.sizeLarge);
  var extraLargeView = size === 'extraLarge' ? React__default.createElement(Stack, {
    ...
    src: imageUpload,
    alt: ""
  }), React__default.createElement(Button, null, actionTitle), React__default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint)) : null;
  var largeView = size === 'large' ? React__default.createElement(Stack, {
    ...
    size: "slim"
  }, actionTitle), React__default.createElement(Caption, null, React__default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint))) : null;
  var mediumView = size === 'medium' ? React__default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, React__default.createElement(Link, null, actionTitle), React__default.createElement(Caption, null, React__default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint))) : null;
...
var getUniqueID$7 = createUniqueIDFactory('DropZone');
...
function (_React$Component) {
  ...
  _createClass(DropZone, [{
    ...
    value: function render() {
      ...
      var classes = classNames(styles$O.DropZone, outline && styles$O.hasOutline, (active || dragging) && styles$O.isDragging, error && styles$O.hasError, size && size === 'extraLarge' && styles$O.sizeExtraLarge, size && size === 'large' && styles$O.sizeLarge, size && size === 'medium' && styles$O.sizeMedium, size && size === 'small' && styles$O.sizeSmall);
...
function (_React$PureComponent) {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$Q.EmptyState, imageContained && styles$Q.imageContained);
      ...
      var footerContentMarkup = footerContent ? React__default.createElement("div", {
        className: styles$Q.FooterContent
      ...
      var detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? React__default.createElement("div", {
        className: styles$Q.DetailsContainer
      }, React__default.createElement("div", {
...
function ExceptionList(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = classNames(styles$S.Item, status && styles$S[variationName('status', status)]);
    var iconMarkup = icon ? React__default.createElement(Icon, {
      source: icon
    }) : React__default.createElement("span", {
      className: styles$S.Bullet
    });
    ...
    var descriptionMarkup = description && React__default.createElement("span", {
      className: styles$S.Description
    }, description);
  ...
  return React__default.createElement("ul", {
    className: styles$S.ExceptionList
  }, items);
}
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      var submitMarkup = implicitSubmit ? React__default.createElement(VisuallyHidden, null, React__default.createElement("button", {
        type: "submit",
        "aria-hidden": "true"
      }, intl.translate('Polaris.Common.submit'))) : null;
...
var Form$1 = withAppProvider()(Form);
...
var getUniqueID$8 = createUniqueIDFactory('FormLayoutGroup');
function Group(_ref) {
  var children = _ref.children,
      condensed = _ref.condensed,
      title = _ref.title,
      helpText = _ref.helpText;
  var className = classNames(condensed ? styles$U.condensed : styles$U.grouped);
  var id = getUniqueID$8();
  ...
  _createClass(Toast, [{
    ...
    value: function render() {
      ...
      var dismissMarkup = React__default.createElement("button", {
        type: "button",
        className: styles$V.CloseButton,
        onClick: onDismiss
      }, React__default.createElement(Icon, {
      ...
      var className = classNames(styles$V.Toast, error && styles$V.error);
      return React__default.createElement("div", {
        className: className
      }, React__default.createElement(KeypressListener, {
        keyCode: Key.Escape,
...
function ToastManager(_ref) {
  ...
  return React__default.createElement(Portal, {
    ...
    className: styles$W.ToastManager,
    "aria-live": "polite"
...
var toastClasses = {
  enter: classNames(styles$W.ToastWrapper, styles$W['ToastWrapper-enter']),
  enterDone: classNames(styles$W.ToastWrapper, styles$W['ToastWrapper-enter-done']),
  exit: classNames(styles$W.ToastWrapper, styles$W['ToastWrapper-exit'])
};
var ToastManager$1 = memo(ToastManager);
...
function Dialog(_a) {
  ...
  var classes = classNames(styles$Y.Modal, large && styles$Y.sizeLarge, limitHeight && styles$Y.limitHeight);
...
var fadeUpClasses = {
  enter: classNames(styles$Y.animateFadeUp, styles$Y.entering),
  enterActive: classNames(styles$Y.animateFadeUp, styles$Y.entered),
  exit: classNames(styles$Y.animateFadeUp, styles$Y.exiting),
  exitActive: classNames(styles$Y.animateFadeUp, styles$Y.exited)
};
...
function Footer(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    className: styles$Z.FooterContent
  }, React__default.createElement(Stack, {
    alignment: "center"
  }, React__default.createElement(Stack.Item, {
    fill: true
...
function CloseButton(_ref) {
  var _ref$title = _ref.title,
      ...
      onClick = _ref.onClick;
  var intl = useI18n();
  var className = classNames(styles$_.CloseButton, !title && styles$_.withoutTitle);
  return React__default.createElement("button", {
    onClick: onClick,
    className: className,
...
function Section$3(_ref) {
  ...
  var className = classNames(styles$10.Section, flush && styles$10.flush, subdued && styles$10.subdued);
...
var getUniqueID$9 = createUniqueIDFactory('modal-header');
    ...
    value: function render() {
      ...
      if (open) {
        ...
        dialog = React__default.createElement(Dialog, {
          ...
          className: styles$11.BodyWrapper
  ...
  _createClass(ContextualSaveBar, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        className: styles$12.ContextualSaveBar
      }, logoMarkup, React__default.createElement("div", {
        className: styles$12.Contents
      }, React__default.createElement("h2", {
        className: styles$12.Message
      }, message), React__default.createElement(Stack, {
        spacing: "tight",
        wrap: false
...
var ContextualSaveBar$3 = withAppProvider()(ContextualSaveBar$2);
...
function Collapsible$1(_ref) {
  ...
  var wrapperClassName = classNames(className, styles$13[variationName('start', type)], inProp && styles$13[variationName('end', type)]);
  ...
  _createClass(Frame, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          intl = _this$props.polaris.intl;
      var navClassName = classNames(styles$14.Navigation, showMobileNavigation && styles$14['Navigation-visible']);
      ...
      var navigationMarkup = navigation ? React__default.createElement(TrapFocus, {
        ...
        type: "button",
        className: styles$14.NavigationDismiss,
      ...
      var loadingMarkup = loadingStack > 0 ? React__default.createElement("div", {
        className: styles$14.LoadingBar,
        id: APP_FRAME_LOADING_BAR
      }, React__default.createElement(Loading, null)) : null;
      var contextualSaveBarMarkup = React__default.createElement(Collapsible$1, {
        "in": showContextualSaveBar,
        className: styles$14.ContextualSaveBar,
        type: AnimationType.Fade
      }, React__default.createElement(ContextualSaveBar$3, this.contextualSaveBar));
      var topBarMarkup = topBar ? React__default.createElement("div", Object.assign({
        className: styles$14.TopBar
      }, layer.props, dataPolarisTopBar.props, {
        id: APP_FRAME_TOP_BAR
      }), topBar) : null;
      var globalRibbonMarkup = globalRibbon ? React__default.createElement("div", {
        className: styles$14.GlobalRibbonContainer,
        ref: this.setGlobalRibbonContainer
      }, globalRibbon) : null;
      var skipClassName = classNames(styles$14.Skip, skipFocused && styles$14.focused);
      var skipMarkup = React__default.createElement("div", {
        ...
        onBlur: this.handleBlur,
        onClick: this.handleClick,
        className: styles$14.SkipAnchor
      }, intl.translate('Polaris.Frame.skipToContent')));
      var navigationAttributes = navigation ? {
        'data-has-navigation': true
      } : {};
      var frameClassName = classNames(styles$14.Frame, navigation && styles$14.hasNav, topBar && styles$14.hasTopBar);
...
var navTransitionClasses = {
  enter: classNames(styles$14['Navigation-enter']),
  enterActive: classNames(styles$14['Navigation-enterActive']),
  enterDone: classNames(styles$14['Navigation-enterActive']),
  exit: classNames(styles$14['Navigation-exit']),
  exitActive: classNames(styles$14['Navigation-exitActive'])
};
...
function Indicator(_ref) {
  ...
  var className = classNames(styles$15.Indicator, pulse && styles$15.pulseIndicator);
  return React__default.createElement("span", {
    className: className
  });
}
...
function KeyboardKey(_ref) {
  ...
  return React__default.createElement("kbd", {
    className: styles$16.KeyboardKey
  }, key);
}
...
function AnnotatedSection(props) {
  ...
  return React__default.createElement("div", {
    className: styles$17.AnnotatedSection
  }, React__default.createElement("div", {
    className: styles$17.AnnotationWrapper
  }, React__default.createElement("div", {
    className: styles$17.Annotation
    ...
    className: styles$17.AnnotationDescription
  }, descriptionMarkup))), React__default.createElement("div", {
    className: styles$17.AnnotationContent
  }, children)));
}
...
function Section$4(_ref) {
  ...
  var className = classNames(styles$17.Section, secondary && styles$17['Section-secondary'], fullWidth && styles$17['Section-fullWidth'], oneHalf && styles$17['Section-oneHalf'], oneThird && styles$17['Section-oneThird']);
  return React__default.createElement("div", {
    className: className
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _createClass(List, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$18.List, type && styles$18[variationName('type', type)]);
...
var getUniqueID$a = createUniqueIDFactory('Select');
function Select(_ref) {
  var optionsProp = _ref.options,
      ...
      _ref$id = _ref.id,
      id = _ref$id === void 0 ? getUniqueID$a() : _ref$id,
      name = _ref.name,
  ...
  var className = classNames(styles$19.Select, error && styles$19.error, disabled && styles$19.disabled);
  ...
  var inlineLabelMarkup = labelInline && React__default.createElement("span", {
    className: styles$19.InlineLabel
  }, label);
  ...
  var contentMarkup = React__default.createElement("div", {
    ...
    className: styles$19.SelectedOption
...
function CheckableButton(_ref) {
  var accessibilityLabel = _ref.accessibilityLabel,
      ...
      disabled = _ref.disabled;
  var className = plain ? classNames(styles$1a.CheckableButton, styles$1a['CheckableButton-plain']) : classNames(styles$1a.CheckableButton, selectMode && styles$1a['CheckableButton-selectMode'], selected && styles$1a['CheckableButton-selected'], measuring && styles$1a['CheckableButton-measuring']);
  return React__default.createElement("div", {
    className: className,
    onClick: onToggleAll
  }, React__default.createElement("div", {
    className: styles$1a.Checkbox
...
function (_React$PureComponent) {
  ...
  _createClass(BulkActionButton, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1b.Button, disabled && styles$1b.disabled);
      return React__default.createElement("button", {
        className: className,
        onClick: onAction,
        onMouseUp: handleMouseUpByBlurring,
...
var slideClasses = {
  appear: classNames(styles$1b.Slide, styles$1b['Slide-appear']),
  appearActive: classNames(styles$1b.Slide, styles$1b['Slide-appearing']),
  enter: classNames(styles$1b.Slide, styles$1b['Slide-enter']),
  enterActive: classNames(styles$1b.Slide, styles$1b['Slide-entering']),
  exit: classNames(styles$1b.Slide, styles$1b['Slide-exit'])
};
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? React__default.createElement("div", {
        className: styles$1b.PaginatedSelectAll
      }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
      var cancelButtonClassName = classNames(styles$1b.Button, styles$1b['Button-cancel'], disabled && styles$1b.disabled);
      ...
      var smallScreenGroup = React__default.createElement(Transition, {
        ...
        var smallScreenGroupClassName = classNames(styles$1b.Group, styles$1b['Group-smallScreen'], styles$1b["Group-".concat(status)]);
        return React__default.createElement("div", {
          ...
          className: styles$1b.CheckableContainer,
      ...
      var largeScreenGroup = React__default.createElement(Transition, {
        ...
        var largeScreenGroupClassName = classNames(styles$1b.Group, styles$1b['Group-largeScreen'], !measuring && styles$1b["Group-".concat(status)], measuring && styles$1b['Group-measuring']);
        return React__default.createElement("div", {
...
function Tag(_ref) {
  ...
  var intl = useI18n();
  var className = classNames(disabled && styles$1c.disabled, styles$1c.Tag);
  ...
  return React__default.createElement("span", {
    ...
    title: children,
    className: styles$1c.TagText
  }, children), React__default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
    className: styles$1c.Button,
    onClick: onRemove,
    onMouseUp: handleMouseUpByBlurring,
    disabled: disabled
  }, React__default.createElement(Icon, {
  ...
  _createClass(DateSelector, [{
    ...
    value: function render() {
      ...
      var datePredicateMarkup = showDatePredicate && React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        className: styles$1d.DateTextField
        ...
        className: styles$1d.DatePicker
...
function FilterControl(_ref) {
  ...
  var appliedFiltersMarkup = appliedFilters.map(function (appliedFilter) {
    ...
    return React__default.createElement("li", {
      className: styles$1e.AppliedFilter,
      key: filterId
  ...
  var appliedFiltersWrapper = appliedFilters.length > 0 ? React__default.createElement("ul", {
    className: styles$1e.AppliedFilters
  ...
  function BaseItem() {
    ...
    _this.handleKeyUp = function (event) {
      var _this$props3 = _this.props,
          ...
          onClick = _this$props3$onClick === void 0 ? noop$8 : _this$props3$onClick,
    ...
    value: function render() {
      ...
      if (media || selectable) {
        ownedMarkup = React__default.createElement("div", {
          className: styles$1f.Owned
        }, handleMarkup, mediaMarkup);
      }

      var className = classNames(styles$1f.Item, focused && styles$1f.focused, selectable && styles$1f.selectable, selected && styles$1f.selected, selectMode && styles$1f.selectMode, persistActions && styles$1f.persistActions, focusedInner && styles$1f.focusedInner);
      ...
      if (shortcutActions && !loading) {
        if (persistActions) {
          ...
          disclosureMarkup = React__default.createElement("div", {
            className: styles$1f.Disclosure,
            onClick: stopPropagation$1
          }, React__default.createElement(Popover, {
            activator: React__default.createElement(Button, {
      ...
      var accessibleMarkup = url ? React__default.createElement(UnstyledLink$1, {
        "aria-describedby": this.props.id,
        "aria-label": accessibilityLabel,
        className: styles$1f.Link,
        url: url,
        tabIndex: tabIndex,
        id: this.overlayId
      }) : React__default.createElement("button", {
        className: styles$1f.Button,
        "aria-label": accessibilityLabel,
        "aria-controls": ariaControls,
        "aria-expanded": ariaExpanded,
        onClick: this.handleClick,
...
function Item$6(props) {
  return React__default.createElement(ResourceListContext.Consumer, null, function (context) {
    return React__default.createElement(BaseItem, Object.assign({}, props, {
      context: context
    }));
  });
}

var Item$7 = withAppProvider()(Item$6);
...
var getUniqueID$b = createUniqueIDFactory('Select');
...
function (_React$Component) {
  ...
  function ResourceList(props) {
    ...
    _this.renderItem = function (item, index) {
      ...
      return React__default.createElement("li", {
        key: id,
        className: styles$1g.ItemWrapper
  ...
  _createClass(ResourceList, [{
    ...
    value: function render() {
      ...
      var filterControlMarkup = filterControl ? React__default.createElement("div", {
        className: styles$1g.FiltersWrapper
      }, filterControl) : null;
      var bulkActionsMarkup = this.selectable ? React__default.createElement("div", {
        className: styles$1g.BulkActionsWrapper
      ...
      var selectId = getUniqueID$b();
      var sortingLabelMarkup = React__default.createElement("label", {
        className: styles$1g.SortLabel,
        htmlFor: selectId
      ...
      var sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? React__default.createElement("div", {
        className: styles$1g.SortWrapper
      }, sortingLabelMarkup, React__default.createElement(Select, {
      ...
      var checkableButtonMarkup = this.selectable ? React__default.createElement("div", {
        className: styles$1g.CheckableButtonWrapper
      ...
      var headerWrapperOverlay = loading ? React__default.createElement("div", {
        className: styles$1g['HeaderWrapper-overlay']
      }) : null;
      ...
      var headerMarkup = !showEmptyState && (showHeader || needsHeader) && this.listRef.current && React__default.createElement("div", {
        className: styles$1g.HeaderOuterWrapper
      }, React__default.createElement(Sticky$1, {
        boundingElement: this.listRef.current
      }, function (isSticky) {
        var headerClassName = classNames(styles$1g.HeaderWrapper, sortOptions && sortOptions.length > 0 && !alternateTool && styles$1g['HeaderWrapper-hasSort'], alternateTool && styles$1g['HeaderWrapper-hasAlternateTool'], _this2.selectable && styles$1g['HeaderWrapper-hasSelect'], loading && styles$1g['HeaderWrapper-disabled'], _this2.selectable && selectMode && styles$1g['HeaderWrapper-inSelectMode'], isSticky && styles$1g['HeaderWrapper-isSticky']);
        return React__default.createElement("div", {
          className: headerClassName
        }, headerWrapperOverlay, React__default.createElement("div", {
          className: styles$1g.HeaderContentWrapper
      ...
      var emptyStateMarkup = showEmptyState ? React__default.createElement("div", {
        className: styles$1g.EmptySearchResultWrapper
      }, React__default.createElement(EmptySearchResult$1, Object.assign({}, this.emptySearchResultText, {
      ...
      var loadingOverlay = loading ? React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        className: styles$1g.SpinnerContainer,
        style: spinnerStyle
      }, React__default.createElement(Spinner, {
        size: spinnerSize,
        accessibilityLabel: "Items are loading"
      })), React__default.createElement("div", {
        className: styles$1g.LoadingOverlay
      })) : null;
      var className = classNames(styles$1g.ItemWrapper, loading && styles$1g['ItemWrapper-isLoading']);
      var loadingWithoutItemsMarkup = loading && !this.itemsExist() ? React__default.createElement("div", {
        className: className,
        tabIndex: -1
      }, loadingOverlay) : null;
      var resourceListClassName = classNames(styles$1g.ResourceList, loading && styles$1g.disabledPointerEvents, selectMode && styles$1g.disableTextSelection);
      ...
      return React__default.createElement(ResourceListContext.Provider, {
        ...
        className: styles$1g.ResourceListWrapper
...
var BOTTOM_CLASS_NAMES = {
  enter: classNames(styles$1h.Bottom, styles$1h.enterBottom),
  enterActive: classNames(styles$1h.Bottom, styles$1h.enterBottomActive),
  exit: classNames(styles$1h.Bottom, styles$1h.exitBottom),
  exitActive: classNames(styles$1h.Bottom, styles$1h.exitBottomActive)
};
var RIGHT_CLASS_NAMES = {
  enter: classNames(styles$1h.Right, styles$1h.enterRight),
  enterActive: classNames(styles$1h.Right, styles$1h.enterRightActive),
  exit: classNames(styles$1h.Right, styles$1h.exitRight),
  exitActive: classNames(styles$1h.Right, styles$1h.exitRightActive)
};
function Sheet(_ref) {
  var children = _ref.children,
      open = _ref.open,
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      var focused = this.state.focused;
      var children = this.props.children;
      var className = classNames(styles$1i.Item, focused && styles$1i['Item-focused']);
      return React__default.createElement("div", {
        onBlur: this.handleBlur,
        onFocus: this.handleFocus,
        className: className
...
function (_React$Component) {
  ...
  _createClass(ConnectedFilterControl, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1i.ConnectedFilterControl, rightPopoverableActions && styles$1i.right);
      var rightMarkup = rightPopoverableActions ? React__default.createElement("div", {
        className: styles$1i.RightContainer
      ...
      var rightActionMarkup = rightAction ? React__default.createElement("div", {
        ...
        className: styles$1i.MoreFiltersButtonContainer
      }, React__default.createElement(Item$8, null, rightAction)) : null;
      var proxyButtonMarkup = rightPopoverableActions ? React__default.createElement("div", {
        className: styles$1i.ProxyButtonContainer,
      ...
      var auxMarkup = auxiliary ? React__default.createElement("div", {
        className: styles$1i.AuxiliaryContainer
      }, auxiliary) : null;
      return React__default.createElement(React__default.Fragment, null, proxyButtonMarkup, React__default.createElement("div", {
        ...
        className: styles$1i.CenterContainer
      }, React__default.createElement(Item$8, null, children)), rightMarkup, rightActionMarkup, React__default.createElement(EventListener, {
        event: "resize",
        handler: this.handleResize
      })), auxMarkup));
    }
...
function popoverFrom(actions) {
  return actions.map(function (action) {
    return React__default.createElement(Item$8, {
      key: action.key
    }, React__default.createElement(Popover, {
  ...
  _createClass(Filters, [{
    ...
    value: function render() {
      ...
      var filtersContentMarkup = filters.map(function (filter, index) {
        ...
        var className = classNames(styles$1j.FilterTriggerContainer, filterIsOpen && styles$1j.open, index === 0 && styles$1j.first, index === filters.length - 1 && styles$1j.last);
        ...
        var appliedFilterBadgeMarkup = appliedFilterContent ? React__default.createElement("div", {
          className: styles$1j.AppliedFilterBadgeContainer
        }, React__default.createElement(Badge, {
          size: "small",
          status: "new"
        ...
        return React__default.createElement("div", {
          ...
          className: styles$1j.FilterTrigger,
          id: "".concat(filter.key, "ToggleButton"),
          type: "button",
          "aria-controls": collapsibleID,
          "aria-expanded": filterIsOpen
        }, React__default.createElement("div", {
          className: styles$1j.FilterTriggerLabelContainer
        }, React__default.createElement("h2", {
          className: styles$1j.FilterTriggerTitle
        }, filter.label), React__default.createElement("span", {
          className: styles$1j.FilterTriggerIcon
        }, React__default.createElement(Icon, {
          source: icon,
          color: "inkLightest"
          ...
          className: styles$1j.FilterNodeContainer
      ...
      var filtersControlMarkup = React__default.createElement(ConnectedFilterControl, {
        ...
        prefix: React__default.createElement("span", {
          className: styles$1j.SearchIcon
        }, React__default.createElement(Icon, {
          source: SearchMinor
        })),
        clearButton: true,
      ...
      var filtersDesktopHeaderMarkup = React__default.createElement("div", {
        className: styles$1j.FiltersContainerHeader
      }, React__default.createElement(DisplayText, {
        size: "small"
      ...
      var filtersDesktopFooterMarkup = React__default.createElement("div", {
        className: styles$1j.FiltersContainerFooter
      }, React__default.createElement(Button, {
        onClick: onClearAll,
      ...
      var filtersMobileFooterMarkup = React__default.createElement("div", {
        className: styles$1j.FiltersMobileContainerFooter
        ...
        className: styles$1j.EmptyFooterState
      ...
      var tagsMarkup = appliedFilters && appliedFilters.length ? React__default.createElement("div", {
        className: styles$1j.TagsContainer
      ...
      var filtersContainerMarkup = mobile ? React__default.createElement(Sheet, {
        ...
        className: styles$1j.FiltersMobileContainerContent,
        shadow: true
        ...
        className: styles$1j.FiltersContainer
      }, filtersDesktopHeaderMarkup, React__default.createElement(Scrollable, {
        className: styles$1j.FiltersDesktopContainerContent,
        shadow: true
      }, filtersContentMarkup), filtersDesktopFooterMarkup));
      return React__default.createElement("div", {
        className: styles$1j.Filters
...
function Loading$1() {
  ...
  useEffect(function () {
    if (appBridge == null) {
      ...
      appBridgeLoading.current = Loading$3.create(appBridge);
      appBridgeLoading.current.dispatch(Loading$3.Action.START);
    }
    ...
    return function () {
      if (appBridge == null) {
        ...
        appBridgeLoading.current && appBridgeLoading.current.dispatch(Loading$3.Action.STOP);
      }
    };
...
var Loading$2 = React__default.memo(Loading$1);
...
var createSecondaryNavigationId = createUniqueIDFactory('SecondaryNavigation');
...
function Item$9(_ref) {
  ...
  var wrappedBadgeMarkup = badgeMarkup == null ? null : React__default.createElement("div", {
    className: styles$1k.Badge
  }, badgeMarkup);
  var itemContentMarkup = React__default.createElement(Fragment, null, iconMarkup, React__default.createElement("span", {
    className: styles$1k.Text
  }, label, indicatorMarkup), wrappedBadgeMarkup);

  if (url == null) {
    var _className = classNames(styles$1k.Item, disabled && styles$1k['Item-disabled']);

    return React__default.createElement("li", {
      className: styles$1k.ListItem
    }, React__default.createElement("button", {
      type: "button",
  ...
  var secondaryActionMarkup = secondaryAction && React__default.createElement(UnstyledLink$1, {
    external: true,
    url: secondaryAction.url,
    className: styles$1k.SecondaryAction,
    tabIndex: tabIndex,
    "aria-disabled": disabled,
  ...
  var itemClassName = classNames(styles$1k.Item, disabled && styles$1k['Item-disabled'], selected && subNavigationItems.length === 0 && styles$1k['Item-selected'], showExpanded && styles$1k.subNavigationActive);
  ...
  if (subNavigationItems.length > 0 && showExpanded) {
    ...
    secondaryNavigationMarkup = React__default.createElement("div", {
      className: styles$1k.SecondaryNavigation
      ...
      return React__default.createElement(Item$9, Object.assign({}, rest, {
        key: label,
        label: label,
  ...
  var className = classNames(styles$1k.ListItem, secondaryAction && styles$1k['ListItem-hasAction']);
  return React__default.createElement("li", {
    className: className
  }, React__default.createElement("div", {
    className: styles$1k.ItemWrapper
  }, React__default.createElement(UnstyledLink$1, {
    url: url,
...
function (_React$Component) {
  ...
  _createClass(Section, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1k.Section, separator && styles$1k['Section-withSeparator'], fill && styles$1k['Section-fill']);
      var actionMarkup = action && React__default.createElement("button", {
        type: "button",
        className: styles$1k.Action,
      ...
      var sectionHeadingMarkup = title && React__default.createElement("li", {
        className: styles$1k.SectionHeading
      }, React__default.createElement("span", {
        className: styles$1k.Text
      }, title), actionMarkup);
      ...
      var toggleClassName = classNames(styles$1k.Item, styles$1k.RollupToggle);
      ...
      var activeItemsMarkup = rollup && additionalItems.length > 0 && React__default.createElement("li", {
        className: styles$1k.RollupSection
  ...
  _createClass(Navigation, [{
    ...
    value: function render() {
      ...
      var contextControlMarkup = contextControl && React__default.createElement("div", {
        className: styles$1k.ContextControl
      }, contextControl);
      var context = {
        location: location,
      ...
      return React__default.createElement(NavigationContext.Provider, {
        ...
        className: styles$1k.Navigation
      }, contextControlMarkup, React__default.createElement(Scrollable, {
        className: styles$1k.PrimaryNavigation
      }, children))));
    }
  }]);
...
function (_React$PureComponent) {
  ...
  function TooltipOverlay() {
    ...
    _this.renderTooltip = function (overlayDetails) {
      ...
      var containerClassName = classNames(styles$1l.Tooltip, light && styles$1l.light, measuring && styles$1l.measuring, positioning === 'above' && styles$1l.positionedAbove);
      var contentStyles = measuring ? undefined : {
...
var getUniqueID$c = createUniqueIDFactory('TooltipContent');
...
function Pagination(_ref) {
  ...
  var className = classNames(styles$1m.Pagination, plain && styles$1m.plain);
  var previousClassName = classNames(styles$1m.Button, styles$1m.PreviousButton);
  var nextClassName = classNames(styles$1m.Button, styles$1m.NextButton);
  var previousButton = previousURL ? React__default.createElement(UnstyledLink$1, {
  ...
  var nextButton = nextURL ? React__default.createElement(UnstyledLink$1, {
  ...
  var constructedPrevious = previousTooltip ? React__default.createElement(Tooltip, {
    content: previousTooltip
  }, previousButton) : previousButton;
  var constructedNext = nextTooltip ? React__default.createElement(Tooltip, {
    content: nextTooltip
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var navigationMarkup = breadcrumbMarkup || paginationMarkup ? React__default.createElement("div", {
        className: styles$1o.Navigation
      ...
      var primaryActionMarkup = primaryAction ? React__default.createElement("div", {
        className: styles$1o.PrimaryActionWrapper
      ...
      var actionMenuMarkup = secondaryActions.length > 0 || hasGroupsWithActions(actionGroups) ? React__default.createElement("div", {
        className: styles$1o.ActionMenuWrapper
      }, React__default.createElement(ActionMenu, {
        actions: secondaryActions,
        groups: actionGroups,
        rollup: mobileView
      })) : null;
      var headerClassNames = classNames(styles$1o.Header, titleHidden && styles$1o.titleHidden, separator && styles$1o.separator, navigationMarkup && styles$1o.hasNavigation, actionMenuMarkup && styles$1o.hasActionMenu, mobileView && styles$1o.mobileView);
      return React__default.createElement("div", {
        className: headerClassNames
      }, navigationMarkup, React__default.createElement("div", {
        className: styles$1o.MainContent
      }, React__default.createElement("div", {
        className: styles$1o.TitleActionMenuWrapper
...
function (_React$PureComponent) {
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1p.Page, fullWidth && styles$1p.fullWidth, (narrowWidth || singleColumn) && styles$1p.narrowWidth);
...
function PageActions(_ref) {
  ...
  return React__default.createElement("div", {
    className: styles$1q.PageActions
  }, React__default.createElement(Stack, {
...
function PolarisTestProvider(_ref) {
  ...
  var stickyManager = new StickyManager(); // This typing is odd, but as appBridge is deprecated and going away in v5
...
function ProgressBar(_ref) {
  var _ref$progress = _ref.progress,
      ...
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var intl = useI18n();
  var className = classNames(styles$1r.ProgressBar, size && styles$1r[variationName('size', size)]);
  ...
  return React__default.createElement("div", {
    ...
    className: styles$1r.Progress,
    value: parsedProgress,
    max: "100"
  }), React__default.createElement("div", {
    className: styles$1r.Indicator,
    style: {
...
function (_React$Component) {
  ...
  _createClass(DualThumb, [{
    ...
    value: function render() {
      ...
      var ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
      var trackWrapperClassName = classNames(styles$1s.TrackWrapper, error && styles$1s.error, disabled && styles$1s.disabled);
      var thumbLowerClassName = classNames(styles$1s.Thumbs, styles$1s.ThumbLower, disabled && styles$1s.disabled);
      var thumbUpperClassName = classNames(styles$1s.Thumbs, styles$1s.ThumbUpper, disabled && styles$1s.disabled);
      ...
      var outputLowerClassName = classNames(styles$1s.Output, styles$1s.OutputLower);
      var outputMarkupLower = !disabled && output ? React__default.createElement("output", {
        ...
        className: styles$1s.OutputBubble
      }, React__default.createElement("span", {
        className: styles$1s.OutputText
      }, value[0]))) : null;
      var outputUpperClassName = classNames(styles$1s.Output, styles$1s.OutputUpper);
...
function SingleThumb(props) {
  ...
  var outputMarkup = !disabled && output && React__default.createElement("output", {
    htmlFor: id,
    className: styles$1t.Output
  }, React__default.createElement("div", {
    className: styles$1t.OutputBubble
  }, React__default.createElement("span", {
    className: styles$1t.OutputText
  }, clampedValue)));
  var prefixMarkup = prefix && React__default.createElement("div", {
  ...
  var className = classNames(styles$1t.SingleThumb, error && styles$1t.error, disabled && styles$1t.disabled);
  return React__default.createElement(Labelled, {
    id: id,
    label: label,
    error: error,
    ...
    className: styles$1t.InputWrapper
  }, React__default.createElement("input", {
    type: "range",
    className: styles$1t.Input,
    id: id,
    name: id,
    min: min,
    max: max,
...
var getUniqueID$d = createUniqueIDFactory('RangeSlider');
...
function (_React$PureComponent) {
  ...
  _createClass(SkeletonPage, [{
    ...
    value: function render() {
      ...
      var headerMarkup = !this.props.polaris.appBridge ? React__default.createElement("div", {
        className: headerClassName
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var markup = url ? React__default.createElement(UnstyledLink$1, Object.assign({}, sharedProps, {
        url: url
  ...
  _createClass(List, [{
    ...
    value: function render() {
      ...
      var tabs = disclosureTabs.map(function (_a, index) {
        ...
        return React__default.createElement(Item$a, Object.assign({}, tabProps, {
          key: id,
          id: id,
...
function (_React$PureComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var markup = url ? React__default.createElement(UnstyledLink$1, {
        id: id,
        url: url,
        role: "tab",
        tabIndex: tabIndex,
  ...
  function TabMeasurer() {
    ...
    _this.handleMeasurement = function () {
      ...
      _this.animationFrame = requestAnimationFrame(function () {
        ...
        var hiddenTabNodes = _this.containerNode instanceof Element && _this.containerNode.children;
...
var createId = createUniqueIDFactory('Toast');

function Toast$1(props) {
  var id = useRef(createId());
  ...
  useDeepEffect(function () {
    ...
    if (appBridge == null) {
      ...
      appBridgeToast.current = Toast$3.create(appBridge, {
        message: content,
        duration: duration,
        isError: error
      });
      appBridgeToast.current.subscribe(Toast$3.Action.CLEAR, onDismiss);
      appBridgeToast.current.dispatch(Toast$3.Action.SHOW);
    }
...
var Toast$2 = React__default.memo(Toast$1);
...
var getUniqueId$2 = createUniqueIDFactory('SearchField');
var SearchField =
/*#__PURE__*/
function (_React$Component) {
...
var TopBarSearchField = withAppProvider()(SearchField);
...
TopBar.SearchField = TopBarSearchField;
TopBar.Menu = Menu;
var TopBar$1 = withAppProvider()(TopBar);

export { AccountConnection, ActionList, ActionMenu, AppBridgeContext, AppProvider, Autocomplete$1 as Autocomplete, Avatar$1 as Avatar, Backdrop, Badge, Banner, Breadcrumbs, Button, ButtonGroup, CalloutCard, Caption, Card$1 as Card, Checkbox$2 as Checkbox, ChoiceList, Collapsible, ColorPicker, Connected, ContextualSaveBar$1 as ContextualSaveBar, DATA_ATTRIBUTE, DEFAULT_TOAST_DURATION, DEFAULT_TOAST_DURATION_WITH_ACTION, DataTable$1 as DataTable, DatePicker$1 as DatePicker, DescriptionList, DisplayText, DropZone$1 as DropZone, EmptySearchResult$1 as EmptySearchResult, EmptyState, EventListener, ExceptionList, FilterType, Filters$1 as Filters, Focus, FooterHelp, Form$1 as Form, FormLayout, Frame$1 as Frame, Heading, Icon, Image, Indicator, InlineError, Key, KeyboardKey, KeypressListener, Label, Labelled, Layout, Link, List, Loading$2 as Loading, Modal$1 as Modal, Navigation$1 as Navigation, OptionList, Page$1 as Page, PageActions, Pagination, PolarisTestProvider, Popover, CloseSource as PopoverCloseSource, Portal, ProgressBar, RadioButton, RangeSlider$1 as RangeSlider, ResourceList$1 as ResourceList, ResourcePicker$1 as ResourcePicker, ScrollLock$1 as ScrollLock, Scrollable, Select, SettingToggle, Sheet, SkeletonBodyText, SkeletonDisplayText, SkeletongBodyText as SkeletonPage, SkeletonThumbnail, Spinner, Stack, Sticky$1 as Sticky, Subheading, Tabs$1 as Tabs, Tag, TextContainer, TextField$1 as TextField, TextStyle, ThemeProvider, Thumbnail, Toast$2 as Toast, Tooltip, TopBar$1 as TopBar, TrapFocus, Truncate, TypeOf, UnstyledLink$1 as UnstyledLink, VisuallyHidden, ScrollLockManagerContext as _SECRET_INTERNAL_SCROLL_LOCK_MANAGER_CONTEXT, WithinContentContext as _SECRET_INTERNAL_WITHIN_CONTENT_CONTEXT, buttonFrom, buttonsFrom, errorTextID, hsbToHex, hsbToRgb, isNavigationItemActive, rgbString, rgbToHex, rgbToHsb, rgbToHsl, rgbaString };
