...
export declare type Size = 'Small' | 'Medium' | 'Large' | 'Full';
...
declare class Modal extends React.Component<CombinedProps, State> {
...
declare const _default: React.FunctionComponent<Props> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<CombinedProps, any> & typeof Modal) | (React.FunctionComponent<CombinedProps> & typeof Modal), {}>;
