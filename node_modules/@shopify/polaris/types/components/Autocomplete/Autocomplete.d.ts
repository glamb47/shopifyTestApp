...
declare class Autocomplete extends React.PureComponent<CombinedProps, never> {
    static TextField: typeof TextField;
    static ComboBox: typeof ComboBox;
    render(): JSX.Element;
}
declare const _default: React.FunctionComponent<Props> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<CombinedProps, any> & typeof Autocomplete) | (React.FunctionComponent<CombinedProps> & typeof Autocomplete), {}>;
