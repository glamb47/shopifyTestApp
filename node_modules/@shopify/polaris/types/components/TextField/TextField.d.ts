...
declare class TextField extends React.PureComponent<CombinedProps, State> {
    ...
    private handleBlur;
    private handleClick;
    private containsAffix;
    private handleButtonPress;
    private handleButtonRelease;
}
declare const _default: React.FunctionComponent<Props> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<CombinedProps, any> & typeof TextField) | (React.FunctionComponent<CombinedProps> & typeof TextField), {}>;
