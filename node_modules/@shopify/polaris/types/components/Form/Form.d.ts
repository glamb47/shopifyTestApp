...
export declare type Target = '_blank' | '_self' | '_parent' | '_top' | string;
...
declare class Form extends React.PureComponent<CombinedProps, never> {
    render(): JSX.Element;
    private handleSubmit;
}
declare const _default: React.FunctionComponent<Props> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<CombinedProps, any> & typeof Form) | (React.FunctionComponent<CombinedProps> & typeof Form), {}>;
