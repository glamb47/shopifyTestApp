...
export declare type TableRow = Props['headings'] | Props['rows'] | Props['totals'];
...
declare class DataTable extends React.PureComponent<CombinedProps, DataTableState> {
...
declare const _default: React.FunctionComponent<Props> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<CombinedProps, any> & typeof DataTable) | (React.FunctionComponent<CombinedProps> & typeof DataTable), {}>;
