...
declare class ResourcePicker extends React.PureComponent<CombinedProps, never> {
...
declare const _default: React.FunctionComponent<Props> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<CombinedProps, any> & typeof ResourcePicker) | (React.FunctionComponent<CombinedProps> & typeof ResourcePicker), {}>;
