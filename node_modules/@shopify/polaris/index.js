...
var getUniqueID$1 = other.createUniqueIDFactory('Popover');
...
function setThemeContext(ctx) {
  var colors = ctx.colors,
      theme = tslib_1.__rest(ctx, ["colors"]);
...
var getUniqueID$2 = other.createUniqueIDFactory('Checkbox');
...
function OptionList(_ref) {
  ...
  var id = React.useRef(propId || getUniqueId());
...
var getUniqueID$7 = other.createUniqueIDFactory('DropZone');
...
var getUniqueID$8 = other.createUniqueIDFactory('FormLayoutGroup');
function Group(_ref) {
  var children = _ref.children,
...
var ToastManager$1 = React.memo(ToastManager);
...
var getUniqueID$9 = other.createUniqueIDFactory('modal-header');
...
var getUniqueID$a = other.createUniqueIDFactory('Select');
...
function (_React$PureComponent) {
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var smallScreenGroup = React__default.createElement(reactTransitionGroup.Transition, {
        timeout: 0,
        "in": selectMode,
        key: "smallGroup",
      ...
      var largeScreenGroup = React__default.createElement(reactTransitionGroup.Transition, {
        timeout: 0,
        "in": selectMode,
        key: "largeGroup",
...
var getUniqueID$b = other.createUniqueIDFactory('Select');
...
var getUniqueID$c = other.createUniqueIDFactory('TooltipContent');
...
function (_React$Component) {
  ...
  function DualThumb() {
    ...
    _this.handleKeypressLower = function (event) {
      ...
      var handlerMap = (_handlerMap = {}, _defineProperty(_handlerMap, exports.Key.UpArrow, incrementValueLower), _defineProperty(_handlerMap, exports.Key.RightArrow, incrementValueLower), _defineProperty(_handlerMap, exports.Key.DownArrow, decrementValueLower), _defineProperty(_handlerMap, exports.Key.LeftArrow, decrementValueLower), _handlerMap);
    ...
    _this.handleKeypressUpper = function (event) {
      ...
      var handlerMap = (_handlerMap2 = {}, _defineProperty(_handlerMap2, exports.Key.UpArrow, incrementValueUpper), _defineProperty(_handlerMap2, exports.Key.RightArrow, incrementValueUpper), _defineProperty(_handlerMap2, exports.Key.DownArrow, decrementValueUpper), _defineProperty(_handlerMap2, exports.Key.LeftArrow, decrementValueUpper), _handlerMap2);
      var handler = handlerMap[event.keyCode];
...
var getUniqueID$d = other.createUniqueIDFactory('RangeSlider');
...
var getUniqueId$2 = other.createUniqueIDFactory('SearchField');
var SearchField =
/*#__PURE__*/
function (_React$Component) {
...
exports.ContextualSaveBar = ContextualSaveBar$1;
